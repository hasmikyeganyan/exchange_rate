...
const initialState = {
  ...
  currencyData: {
    ...
    EUR: { displayLabel: "Euro", code: "EUR", rate: 0.82 },
    JPY: { displayLabel: "Japan", code: "JPY", rate: 109.38 },
    CAD: { displyLabel: "Canadian dollar", code: "CAD", rate: 1.21 },
    GBP: { displyLabel: "Pound sterling", code: "GBP", rate: 0.71 },
    MXN: { displyLabel: " Mexican peso", code: "MXN", rate: 19.86 },
  },
